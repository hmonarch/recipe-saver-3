const sitePreviewRecipes = [
  {
    title: 'Juicy Steakhouse Burgers',
    date: 1565063396975,
  ...
  },
  {
    ...
    description: [
      'Score the pork belly skin at 1/2 inch intervals. Rub with the wine vinegar and refrigerate for 2 hours uncovered. Rub some salt into the cracks of the skin, then sprinkle with sea salt flakes.',
      'Place the garlic, thyme and shallots on the bottom of a roasting pan and put the pork on top. Put the roasting pan in a preheated 450 degrees F oven for 20 minutes.',
      'Pour in the cider, being careful not to wet the pork.  Reduce the oven temperature to 350 degrees F and continue to roast for 3 hours until the skin is as crispy as it’s going to get.'
    ]
  },
  {
  ...
  {
    title: 'Red Velvet-Coconut Biscotti',
    date: 1515062610948,
...
export default sitePreviewRecipes;