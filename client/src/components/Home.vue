  ...
  <div class="home">
    ...
    <div class="white-boxes">
      <div class="plans">
        ...
        <div class="plans-subheadline">Choose just the basics or get the ful tool</div>
        ...
        <div class="plan lite">
          ...
          <div class="plan-right">
            ...
            <div class="plan-cost-details">Upgrade later to save unlimited recipes</div>
